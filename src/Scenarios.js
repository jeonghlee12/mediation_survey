...
class Scenarios extends React.Component {
    ...
    render() {
        ...
        if (stage === "intro") {
            ...
            content = <QuestionsScenario saveTime={this.props.saveTime} agent={this.props.agent} scenario={this.props.scenarioOrder} skipStage={this.props.skipStage} saveDictToState={this.props.saveDictToState}/>
        }
        return (
            <div>
                {content}
